...
- GENERATED ALWAYS AS columns are strictly computed by the database with no manual override allowed, whereas GENERATED BY DEFAULT AS columns are computed by default but can be manually inserted or updated.
- 
---
